  ...
  const standards = [
    {
      ...
      description: "Our mobile detailing rigs and Bayside facility are equipped with specialized high Color Rendering Index diffuse inspection lamps that expose every micro-scratch, hologram, and clear coat flaw that standard ambient lights hide."
    },
    {
      icon: <Droplets className="w-6 h-6 text-sky-400" />,
      title: "0-PPM Deionized Pure Water & Onboard Power",
      description: "Our self-contained mobile units and Bayside studio utilize multi-stage deionization resin filtration that strips 100% of minerals and calcium, powered by whisper-quiet onboard inverter generators."
    },
    {
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          <div className="inline-flex items-center space-x-2 px-3 py-1 rounded-full bg-amber-500/10 border border-amber-500/20 text-xs font-mono-tech text-amber-400 mb-3">
            ...
            <span>The RetroClean Detailing Difference</span>
          </div>
          ...
          <p className="mt-3 text-slate-400 text-sm sm:text-base">
            We bring clinical grade detailing, pure deionized water, and onboard power directly to your doorstep in Bayside, Queens & Long Island.
          </p>
        </div>
        ...
        <div className="mt-12 bg-gradient-to-r from-[#151a24] via-[#10141e] to-[#151a24] border border-white/10 rounded-2xl p-6 sm:p-8 flex flex-col md:flex-row items-center justify-between gap-6">
          <div className="space-y-2 text-center md:text-left">
            <span className="text-xs font-mono-tech text-amber-400 uppercase font-semibold">Mobile & Studio Fleet Specification</span>
            <div className="text-xl sm:text-2xl font-display font-bold text-white">
              Self-Contained Mobile Units & {BUSINESS_INFO.addressShort} Studio
            </div>
            <p className="text-xs text-slate-400 max-w-xl">
              100% self-sufficient mobile vans carrying onboard 100-gallon pure water tanks, silent Honda inverter generators, and high-pressure steam extractors. No water hookup or electrical outlet needed from your home.
            </p>
          </div>
          <div className="flex items-center space-x-3 shrink-0">
            <div className="text-right font-mono-tech text-xs hidden sm:block">
              <span className="text-emerald-400 font-bold block">● Fully Mobile with Water & Power</span>
              <span className="text-slate-400">Serving Queens & Long Island</span>
            </div>
