...
export const ServicesSection: React.FC<ServicesSectionProps> = ({ onSelectServiceForQuote }) => {
  ...
  const getServiceIcon = (id: string) => {
    switch (id) {
      case 'mobile-hand-wash-wax':
        return <Droplets className="w-5 h-5" />;
      case 'interior-deep-clean-steam':
        return <Sparkles className="w-5 h-5" />;
      case 'paint-correction-gloss':
        return <Wrench className="w-5 h-5" />;
      case 'leather-carpet-extraction':
        return <Layers className="w-5 h-5" />;
      case 'ceramic-maintenance-tire-rim':
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-16 gap-6">
          <div>
            <span className="text-xs uppercase tracking-[0.25em] font-mono-tech text-amber-400 font-semibold block mb-2">
              On-Site Craftsmanship Disciplines
            </span>
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-display font-black text-white tracking-tight">
              Featured Mobile Services
            </h2>
          </div>
          <p className="text-slate-400 text-sm max-w-md">
            Every vehicle serviced by Jonathan's Mobile Carwash receives clinical grade attention, 100% deionized spot-free water, and professional execution directly at your doorstep across Queens, Long Island & Greater NYC.
          </p>
        </div>
        ...
        <div className="bg-[#0f131d] border border-white/10 rounded-2xl overflow-hidden shadow-2xl p-6 lg:p-10">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
            ...
            <div className="lg:col-span-7 space-y-6">
              ...
              {/* Action Buttons: Direct customer inquiry call / quote */}
              <div className="flex flex-wrap gap-4 pt-2">
                ...
                >
                  <span>Instant Mobile Quote</span>
              ...
              <div className="relative rounded-2xl overflow-hidden aspect-[4/3] bg-black border border-white/15 shadow-2xl group">
                ...
                <div className="absolute bottom-4 left-4 right-4 bg-[#090b10]/90 backdrop-blur-md p-3.5 rounded-xl border border-white/15">
                  <div className="flex items-center justify-between text-xs">
                    <span className="font-mono-tech text-amber-400 font-semibold uppercase">Jonathan's Mobile Carwash</span>
                    <span className="text-slate-400">Queens, LI & NYC</span>
                  </div>
