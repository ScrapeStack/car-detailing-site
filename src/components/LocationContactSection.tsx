      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          <div className="inline-flex items-center space-x-2 px-3 py-1 rounded-full bg-amber-500/10 border border-amber-500/20 text-xs font-mono-tech text-amber-400 mb-3">
            ...
            <span>Beverly Hills Detailing Center</span>
          </div>
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-display font-black text-white tracking-tight">
            Visit Our East Elmhurst Facility or Call For Service
          </h2>
          <p className="mt-3 text-slate-400 text-sm sm:text-base">
            Conveniently located at {BUSINESS_INFO.address} right on Astoria Blvd in East Elmhurst, Queens with fast access from Grand Central Pkwy, Astoria, Flushing, and Manhattan.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch">
          ...
          <div className="lg:col-span-5 bg-[#121620] border border-white/10 rounded-2xl p-6 sm:p-8 flex flex-col justify-between space-y-6">
              ...
              <div className="space-y-4 text-xs sm:text-sm">
                <div className="flex items-start space-x-3 text-slate-300">
                  ...
                  <div>
                    ...
                    <div className="text-[11px] text-slate-400 mt-0.5 font-mono-tech">Auto Detailing, Hand Wash, Ceramic Coating & Paint Correction</div>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-3 text-slate-300">
                  ...
                  <div>
                    ...
                    <div className="text-[11px] text-slate-400 mt-0.5">Direct line to Master Detailer (Call or Text)</div>
                  </div>
                </div>
            ...
            {/* Quick Action Bar: Call Now and Book Appointment both trigger call to (718) 777-7600 */}
          ...
          <div className="lg:col-span-7 bg-[#0f131d] border border-white/10 rounded-2xl overflow-hidden shadow-2xl flex flex-col">
            ...
            <div className="relative h-64 sm:h-72 bg-[#1a202c] overflow-hidden border-b border-white/10">
              ...
              {/* East Elmhurst Map Marker Center */}
              <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-center z-10">
                ...
                <div className="bg-[#090b10]/95 backdrop-blur-md border border-amber-500/40 px-3.5 py-1.5 rounded-lg text-xs font-bold text-white mt-1 shadow-xl font-mono-tech">
                  Beverly Hills Detailing • {BUSINESS_INFO.addressShort}
                </div>
              </div>
              ...
              {!inquirySent ? (
                ...
                <div className="text-center py-6 space-y-3">
                  ...
                  <p className="text-xs text-slate-300 max-w-sm mx-auto">
                    Thank you {inquiryData.name}. Our master detailer at Beverly Hills Detailing Center will contact you at {inquiryData.phone} shortly.
                  </p>
                  <button
                    onClick={() => {
