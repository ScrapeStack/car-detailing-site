      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-display font-black text-white tracking-tight">
            Auto Detailing at 233 Brinsmade Ave in the Bronx
          </h2>
          <p className="mt-3 text-slate-400 text-sm sm:text-base">
            Conveniently located at {BUSINESS_INFO.address}, offering complete auto detailing, paint correction, ceramic coatings, and headlight restoration.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch">
          ...
          <div className="lg:col-span-5 bg-[#121620] border border-white/10 rounded-2xl p-6 sm:p-8 flex flex-col justify-between space-y-6">
            <div className="space-y-6">
              <div>
                <span className="text-xs font-mono-tech uppercase text-amber-400 font-bold">Facility Location & Contact</span>
              ...
              <div className="space-y-4 text-xs sm:text-sm">
                <div className="flex items-start space-x-3 text-slate-300">
                  ...
                  <div>
                    <strong className="text-white block font-medium">Bronx Location:</strong>
                    <span>{BUSINESS_INFO.address}</span>
                    <div className="text-[11px] text-slate-400 mt-0.5 font-mono-tech">Facility Detailing Bay & Mobile Inquiries</div>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-3 text-slate-300">
                  ...
                  <div>
                    <strong className="text-white block font-medium">Call Concierge:</strong>
                    <a href={`tel:${BUSINESS_INFO.phoneRaw}`} className="text-amber-400 font-bold hover:underline">
                      {BUSINESS_INFO.phone}
                    </a>
                    <div className="text-[11px] text-slate-400 mt-0.5">Direct Call for Appointments & Quotes</div>
                  </div>
                </div>
          ...
          <div className="lg:col-span-7 bg-[#0f131d] border border-white/10 rounded-2xl overflow-hidden shadow-2xl flex flex-col">
            ...
            <div className="relative h-64 sm:h-72 bg-[#1a202c] overflow-hidden border-b border-white/10">
              ...
              <div className="absolute top-3 left-3 bg-[#090b10]/90 backdrop-blur-md border border-white/10 px-3 py-1 rounded-md text-[10px] font-mono-tech text-slate-300">
                Bronx, NY 10465 • 233 Brinsmade Ave
              </div>
              ...
              {!inquirySent ? (
                ...
                <div className="text-center py-6 space-y-3">
                  ...
                  <p className="text-xs text-slate-300 max-w-sm mx-auto">
                    Thank you {inquiryData.name}. Our team at Zephyr Auto Spa will contact you at {inquiryData.phone} shortly.
                  </p>
                  <button
                    onClick={() => {
