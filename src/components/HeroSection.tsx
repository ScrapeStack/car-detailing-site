      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full pt-6 sm:pt-9 lg:pt-11 pb-7 sm:pb-9 relative z-10 my-auto">
        ...
        >
          ...
          >
            ...
            <span className="text-slate-300 font-semibold">{BUSINESS_INFO.address}</span>
            <span className="text-slate-600">•</span>
            <span className="text-amber-400 font-bold">{BUSINESS_INFO.rating}★ ({BUSINESS_INFO.reviewCount}+ Reviews)</span>
          </motion.div>

          {/* Hero Headline: Beverly Hills Detailing Center on Astoria Blvd */}
          <motion.div 
            className="space-y-2"
            variants={{
          ...
          >
            ...
            <p className="text-xs sm:text-sm font-mono-tech uppercase tracking-wider text-amber-400 font-bold pt-0.5">
              Professional Auto Detailing on Astoria Blvd in East Elmhurst
            </p>
          </motion.div>
          ...
          >
            <div>
              <p>
                Full interior & exterior auto detailing and premium hand wash & paint protection wax at 70-11 Astoria Blvd N in East Elmhurst, NY.
              </p>
            </div>
            <div>
              <p>
                Ceramic coating & paint correction, leather cleaning & conditioning, and engine bay restoration. Call (718) 777-7600 to reserve your spot.
              </p>
            </div>
          </motion.div>

          {/* Clean Action Buttons: Triggering Call to (718) 777-7600 as requested */}
          <motion.div 
          ...
          >
            {/* Primary Action Button: BOOK APPOINTMENT -> triggers call */}
            <motion.a
