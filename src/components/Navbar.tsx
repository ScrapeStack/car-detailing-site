      ...
      <header className={`sticky top-0 z-40 transition-all duration-300 ${
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex justify-between items-center">
          ...
          <a href="#" className="flex items-center space-x-3 group" id="nav-brand-logo">
            ...
            <span className="hidden sm:inline-block text-[11px] tracking-[0.18em] text-slate-400 uppercase font-mono-tech font-bold">
              DETAILING CENTER
            </span>
          </a>
          ...
          {/* Action CTAs: Book Appointment triggering call to (718) 777-7600 */}
          ...
          <div className="flex items-center space-x-2 lg:hidden">
            <a
              ...
              aria-label="Call Beverly Hills Detailing Center at (718) 777-7600"
            >
          ...
          <div className="lg:hidden bg-[#0a0d14] border-b border-white/10 px-4 pt-3 pb-6 mt-3 space-y-3 animate-in slide-in-from-top duration-200">
            ...
            <div className="pt-3 border-t border-white/10 flex flex-col gap-2.5">
              ...
              >
                ...
                <span>BOOK APPOINTMENT: (718) 777-7600</span>
              </a>
              <button
