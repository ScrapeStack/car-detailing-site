        ...
        <div className="max-w-7xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-6">
          <div className="space-y-1 text-center sm:text-left">
            ...
            <div className="text-xl sm:text-2xl font-display font-black text-white">
              Schedule Mobile Detailing or Call / Text Us Today
            </div>
            <div className="text-xs text-slate-400 font-mono-tech">
              Mon-Sat: 8:00 AM - 6:00 PM • Serving Bayside, Queens & Long Island (We Bring Water & Power)
            </div>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10">
          ...
          <div className="lg:col-span-2 space-y-4">
            ...
            <p className="text-slate-400 text-xs leading-relaxed max-w-sm">
              Premium mobile auto detailing in Bayside, Queens & Long Island. We bring pure deionized water and electric power right to your home or office. Specializing in mobile full resets, long-term ceramic coatings, window tinting, vehicle wraps, recurring care plans, and deep stain & odor extraction.
            </p>
          ...
          <div className="space-y-3">
            ...
            <div className="space-y-2.5 text-slate-400">
              ...
              <div className="pt-1 text-[11px] font-mono-tech space-y-1">
                <div className="text-slate-300">{BUSINESS_INFO.hours.weekdays}</div>
                <div className="text-amber-400">{BUSINESS_INFO.hours.sunday}</div>
              </div>
              <div className="text-[11px] text-slate-500 font-mono-tech pt-1">
                Serving: Bayside, Whitestone, Douglaston, Little Neck, Flushing, Queens & Long Island.
              </div>
            </div>
          </div>
        </div>
