      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-14">
          <div className="inline-flex items-center space-x-2 px-3 py-1 rounded-full bg-amber-500/10 border border-amber-500/20 text-xs font-mono-tech text-amber-400 mb-3">
            ...
            <span>Transparent Concourse Detailing Pricing</span>
          </div>
          ...
          <p className="mt-3 text-slate-400 text-sm sm:text-base">
            Select your vehicle class below to view real-time adjusted rates. All detailing packages are handled at our East Elmhurst location on Astoria Blvd.
          </p>
