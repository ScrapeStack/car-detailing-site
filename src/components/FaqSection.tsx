      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-14">
          ...
          <p className="mt-3 text-slate-400 text-sm">
            Everything you need to know about our professional mobile hand wash, interior steam sanitization, paint correction, and on-site detailing services across Queens, Long Island & Greater NYC.
          </p>
        </div>
