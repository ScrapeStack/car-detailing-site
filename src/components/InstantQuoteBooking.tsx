...
export const InstantQuoteBooking: React.FC<InstantQuoteBookingProps> = ({
  ...
  const handleFormSubmit = (e: React.FormEvent) => {
    ...
    const code = `ASTORIA-${Math.floor(100000 + Math.random() * 900000)}`;
          ...
          <div className="lg:col-span-8 bg-[#0f131d] border border-white/10 rounded-2xl p-6 sm:p-8 shadow-2xl space-y-8">
            <form onSubmit={handleFormSubmit} className="space-y-8">
              ...
              <div className="pt-2 border-t border-white/10">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mb-4">
                  ...
                  >
                    <div className="flex items-center space-x-2">
                      ...
                      <span className="font-bold text-xs text-white">Astoria Studio Bay</span>
                    </div>
                    <p className="text-[11px] text-slate-400 mt-1">
                      42-09 31st Ave, Astoria, NY (Climate-controlled detailing bays)
                    </p>
                  </button>
                ...
                {formData.serviceMode === 'mobile' && (
                  <div className="mb-4">
                    <label className="text-xs text-slate-300 font-mono-tech block mb-1">Your Mobile Service Address in Astoria / Queens / NYC:</label>
                    <input
                      type="text"
                      id="booking-address-input"
                      placeholder="e.g. 31-10 Broadway, Astoria, NY 11106"
            ...
            <div className="bg-[#121622] border border-amber-500/30 rounded-2xl p-6 shadow-2xl space-y-5">
              ...
              <div className="space-y-3 text-xs">
                ...
                <div className="flex justify-between text-slate-300 pt-2 border-t border-white/5">
                  ...
                  <span className="font-bold text-white capitalize">{formData.serviceMode === 'studio' ? 'Astoria Studio Bay' : 'Mobile Unit (Astoria / Queens Area)'}</span>
                </div>
          ...
          <div className="bg-[#121622] border border-amber-500/40 rounded-2xl max-w-lg w-full p-6 sm:p-8 shadow-2xl space-y-6 text-center animate-in zoom-in-95 duration-200">
            ...
            <div className="space-y-2">
              ...
              <p className="text-xs text-slate-300">
                Thank you <strong className="text-white">{formData.fullName}</strong>. Our Astoria concierge team has received your appointment request for your <strong className="text-white">{formData.vehicleYearMakeModel || selectedVehicleObj.name}</strong>.
              </p>
            </div>
            ...
            <div className="bg-[#090b10] border border-white/10 rounded-xl p-4 text-xs text-left space-y-2 font-mono-tech">
              ...
              <div className="flex justify-between"><span className="text-slate-400">Service Mode:</span><span className="text-white">{formData.serviceMode === 'studio' ? 'Astoria Studio' : 'Mobile Unit'}</span></div>
